# Changelog — quark-holder-service
...
## v0.1.0 — Integración con quark-wallet — [27/04/2026]
- Integración con quark-wallet.
...
- Migración de `@one/credo` a `@quarkid/identity-core`.
