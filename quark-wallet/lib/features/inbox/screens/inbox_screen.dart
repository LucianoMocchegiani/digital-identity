...
/// carga y error explícitos; lista vacía con [QuarkEmptyState]. Las filas van en
/// una [QuarkCard]: cada [_ConnectionTile] muestra etiqueta, `goalCode` o estado
...
class InboxScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      appBar: QuarkPageAppBar.build(title: 'Conexiones'),
      body: async.when(
