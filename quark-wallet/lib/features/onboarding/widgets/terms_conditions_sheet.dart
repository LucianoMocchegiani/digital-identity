...
const _termsBlocks = <_LegalBlock>[
  _LegalBlock(
    ...
    'Bienvenido/a a la wallet de QuarkID. Estos Términos y Condiciones (en '
        ...
        'por sus siglas en inglés). Al usar la wallet (en adelante, “QuarkID '
  ...
  _LegalBlock(
    _BlockType.bullet,
    'En estos Términos se hace mención a QuarkID como framework tecnológico '
        '(será únicamente “QuarkID” o como “QuarkID wallet”, de acuerdo con lo '
        'definido en el primer párrafo).',
  ),
  _LegalBlock(_BlockType.heading, 'DEFINICIONES:'),
  _LegalBlock(
    _BlockType.paragraph,
    'QuarkID es un framework de confianza digital descentralizado, público, no '
