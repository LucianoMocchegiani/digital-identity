...
///
/// Explica el riesgo y ofrece un [QuarkDangerButton] que abre el
/// [QuarkConfirmModal] compartido. Si el usuario acepta, llama a
...
class _ResetWalletScreenState extends ConsumerState<ResetWalletScreen> {
  ...
  Future<void> _confirmReset() async {
    final confirmed = await QuarkConfirmModal.show(
      context,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: QuarkPageAppBar.build(title: 'Reiniciar wallet'),
      body: Padding(
