...
class FlowSheetScaffold extends StatelessWidget {
  ...
  /// Sheet a mostrar (típicamente un [QuarkFlowSheet]).
  final Widget sheet;
...
class QuarkFlowSheet extends StatefulWidget {
  const QuarkFlowSheet({
    super.key,
    required this.title,
  ...
  @override
  State<QuarkFlowSheet> createState() => _QuarkFlowSheetState();
}

class _QuarkFlowSheetState extends State<QuarkFlowSheet>
