...
/// Modal de error (paridad visual con [QuarkSuccessModal]).
///
...
class QuarkErrorModal extends StatelessWidget {
  const QuarkErrorModal({
    super.key,
    required this.title,
  ...
  static Future<void> show(
    ...
    return showDialog(
      ...
      builder: (_) => QuarkErrorModal(title: title, description: description),
    );
  }
