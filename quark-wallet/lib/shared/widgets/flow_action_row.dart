...
import 'quark_primary_button.dart';

/// Fila estándar cancelar + acción principal (ancho expandido, 12 px de separación).
///
/// Usa los botones del design system: [QuarkOutlineButton] (expandido) para
/// cancelar y [QuarkPrimaryButton] para la acción principal. Si [onPrimary] es
