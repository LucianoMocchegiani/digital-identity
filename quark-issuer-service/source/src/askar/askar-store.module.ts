 ...
 *
 * Prerequisito compartido de {@link AskarKeyManagementService} y
 * {@link AskarRecordStorage}: Credo monta el store con estas opciones.
 *
 ...
 *
 * No instancia KMS ni records: solo la config para el `AskarModule` store-only.
 */
@Global()
@Module({
  providers: [
