...
export function FeatureStrip() {
  return (
    <MarketingShell as="section" className="pb-20">
      <div className="grid gap-6 rounded-2xl border border-white/10 bg-[var(--kuatia-panel)]/60 p-6 md:grid-cols-3 md:gap-0 md:divide-x md:divide-white/10 md:p-8 lg:p-10">
