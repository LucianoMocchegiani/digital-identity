  ...
  return (
    ...
    >
      <div className="relative z-10">
        <p className="font-display text-xl font-semibold tracking-tight text-[var(--kuatia-accent)] sm:text-2xl">
          Kuatia
        </p>
        <h1 className="mt-3 font-display text-4xl font-semibold leading-[1.1] tracking-tight text-[var(--kuatia-text)] sm:text-5xl md:text-5xl lg:text-6xl">
          Privacidad para tus usuarios. Identidad sin fraude.
        </h1>
        <p className="mt-5 max-w-xl text-base leading-relaxed text-[var(--kuatia-muted)] sm:mt-6 sm:text-lg">
