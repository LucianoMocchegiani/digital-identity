...
export default function DocsRecomendacionesPage() {
  return (
    <>
      ...
      <DocsLead>
        Guías prácticas para diseñar credenciales y flujos sin ser experto en SSI. El objetivo:
        menos datos expuestos, menos riesgo y mejor experiencia para el usuario.
      </DocsLead>
      ...
      <DocsP>
        ...
        privacidad. Preferí identificadores o flags de negocio (“socio activo”, “nivel gold”)
        frente a volcar historiales o documentos completos en la credencial.
      </DocsP>
      ...
      <DocsP>
        ...
        nombre + estado, no el email si no hace falta).
      </DocsP>
      ...
      <DocsUl>
        ...
        <li>PII que no vas a pedir nunca en una presentación</li>
      </DocsUl>

      <DocsH2>Branding vs configuración técnica</DocsH2>
      <DocsP>
        Personalizá nombre, logo y colores de la card. Dejá format, vct y algoritmos como los
        provisionó Kuatia. Tipos de credencial nuevos: pedilos al equipo Kuatia.
      </DocsP>
      ...
      <DocsUl>
        ...
        <li>Chequeá <code className="text-sm">/v1/health/ready</code> antes de picos de emisión.</li>
        <li>Cada offer/request consume cuota del plan: evitá crear ofertas que nadie va a escanear.</li>
      </DocsUl>
    </>
  )
}
